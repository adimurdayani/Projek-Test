        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->segment(2) == 'product' ? 'active' : '' }}">
                    <a href="{{ route('app.product.index') }}" class='sidebar-link'>
                        <i class="bi bi-cart"></i>
                        <span>Produk</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->segment(2) == 'transaction' ? 'active' : '' }}">
                    <a href="{{ route('app.transaction.index') }}" class='sidebar-link'>
